...
if(runinit)
{
S2simfitring0.year = stan(file="exec/agereader_year_strat0.stan",data=d.comb0,
...
S2simfitcomb0.year = stan(file="exec/agereader_comb_year_strat0.stan",data=d.comb,
