...
if(runinit)
{
SimR3fitring0.year = stan(file="exec/agereader_year_strat0.stan",data=d.comb0,
...
SimR3fitcomb0.year = stan(file="exec/agereader_comb_year_strat0.stan",data=d.comb,
